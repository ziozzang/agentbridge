...
| --- | --- | --- | --- |
| `glm` | `Z_AI_API_KEY` / `AGENTBRIDGE_API_KEY` | ACP chat, Chat Completions 호환 GLM route | 내장 file/web tool, Z.AI MCP web tool. Shell은 ACP client가 광고한 경우 `client__run_command`로 client-owned 실행 |
